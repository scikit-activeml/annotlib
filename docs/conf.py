...
htmlhelp_basename = 'annotlibguide'
    ...
    'preamble': r"""\usepackage{amsmath}\usepackage{amsfonts}\usepackage{bm}
                    ...
                    \begin{titlepage} 
                           \begin{center}
                                ...
                                \vspace*{1cm} \Huge {\textbf{annotlib: Annotator Library -- User~Guide} }\\
...
latex_documents = [
    (master_doc, 'annotlib.tex', 'annotlib: Annotator Library -- User Guide',
     'Marek Herde', 'manual'),
]
...
man_pages = [
    (master_doc, 'annotlib', 'annotlib: Annotator Library -- User Guide',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'annotlib', 'annotlib: Annotator Library -- User Guide',
     author, 'annotlib', 'Annotator Library',
     'Miscellaneous'),
]
